...
if ( ! class_exists( 'bt_Protocol_Relative_Theme_Assets' ) ) :
	class bt_Protocol_Relative_Theme_Assets {
		/**
	...
	$bt_protocol_relative_theme_assets = new bt_Protocol_Relative_Theme_Assets;
endif;
